...
- [SihyeonJeon/tool-tax](https://github.com/SihyeonJeon/tool-tax) 🐍 - Schema-budget linter for MCP configs and tool catalogs. Probes stdio servers via `tools/list`, ranks heavy schemas, and can fail CI on catalog growth.
